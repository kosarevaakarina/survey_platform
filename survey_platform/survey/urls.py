...
from survey.views.views_of_rating import RatingCreateAPIView, RatingUpdateAPIView
...
urlpatterns = [
    ...
    path('rating/update/<int:pk>/', RatingUpdateAPIView.as_view(), name='rating_update'),
]
