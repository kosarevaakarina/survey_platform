...
class ChoiceCreateAPITestCase(UserCreate):
    ...
    def create_response(self):
        ...
        response = self.client.post('/survey/choice/create/', {
...
class ChoiceRetrieveAPITestCase(UserCreate):
    ...
    def retrieve_response(self, pk):
        ...
        response = self.client.get(f'/survey/choice/{pk}/')
        return response
...
class ChoiceUpdateAPITestCase(UserCreate):
    ...
    def update_response(self, pk):
        ...
        response = self.client.patch(f'/survey/choice/update/{pk}/', {'choice': 'Update choice'})
        return response
...
class ChoiceDeleteAPITestCase(UserCreate):
    ...
    def delete_response(self, pk):
        ...
        response = self.client.delete(f'/survey/choice/delete/{pk}/')
        return response
